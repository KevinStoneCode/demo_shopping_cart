...
RSpec.describe Cart, type: :model do
  describe "購物車基本功能" do
    it "可以把商品丟到到購物車裡，然後購物車裡就有東西了" do 
      ...
      expect(cart.empty?).to be false #購物車不是空的
    end
    ...
    it "可以計算整台購物車的總消費金額" do 
      ...
      p2 = Product.create(title:"冒險野狼", price: 200)
    ...
    it "特別活動可能可搭配折扣（例如聖誕節的時候全面打 9 折，或是滿額滿千送百）" do 
      p1 = Product.create(title:"七龍珠", price: 80)
      p2 = Product.create(title:"冒險野狼", price: 200)
      p3 = Product.create(title:"幽游白書", price: 1000)
      ...
      expect(cart.total_price).to be 3540
    end
